 ...
 */
import { ensureError, RestateError, SUSPENDED_ERROR_CODE, TerminalError, } from "../../types/errors.js";
...
export class GenericHandler {
    ...
    async handleInvoke(handler, body, headers, extraArgs, additionalContext) {
        ...
        // Prepare context
        const ctx = new ContextImpl(coreVm, input, console, handler.kind(), headers, extraArgs, invocationEndPromise, inputReader, outputWriter);
...
export function vm_log(level, str) {
    defaultLogger({
